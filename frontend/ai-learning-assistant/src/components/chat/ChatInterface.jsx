...
const ChatInterface = () => {
    ...
    const renderMessage = (msg,index)=>{
        ...
        return (
            <div key={index} className={`flex items-end gap-3 mb-6 ${isUser ? 'flex-row-reverse':'flex-row'}`}>
                {/* Avatar */}
                {isUser ? (
                ...
                <div className={`max-w-[70%] px-5 py-3.5 rounded-2xl shadow-sm ${
                    isUser
                        ? 'bg-linear-to-br from-emerald-500 to-teal-500 text-white rounded-br-sm'
    ...
    if(initialLoading){
        return (
            <div className="flex flex-col h-[70vh] w-full bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl items-center justify-center shadow-xl shadow-slate-200/50">
    ...
    return (
        <div className="flex flex-col h-[70vh] w-full bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden">
            {/* Message Area */}
            <div className="flex-1 p-6 overflow-y-auto bg-linear-to-br from-slate-50/50 via-white/50 to-slate-50/50">
                ...
                {loading && (
                    <div className="flex items-end gap-3 mb-6">
                        ...
                        <div className="flex items-center gap-2 px-5 py-3.5 rounded-2xl rounded-bl-sm bg-white border border-slate-200/60">
